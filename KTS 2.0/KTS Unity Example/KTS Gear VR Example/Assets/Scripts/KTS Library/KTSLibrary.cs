...
*/
    ...
    public delegate void onBodyDelegate(KTS_Person_Serialize_Object.MessageObject.Person[] body);
    ...
    {
        RuntimeTypeModel.Default[typeof(KTS_Person_Serialize_Object.MessageObject.Joint)][1].SupportNull = true;

        state.Message.Position = 0;
        KTS_Person_Serialize_Object.MessageObject.KTSMessage MessageData = KTS_Person_Serialize_Object.KTSSerializer.DeSerializeKTSMessage(state.Message);

        // Deserialize the hashtable from the file and 
        // assign the reference to the local variable.
       
        // Debug.Log("Message recived!");
        onBodyCallback(MessageData.People);
